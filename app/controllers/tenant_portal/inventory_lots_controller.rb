module TenantPortal
  class InventoryLotsController < TenantPortal::BaseController
    ...
    def create
      @inventory_lot = current_tenant.inventory_lots.new(inventory_lot_params.except(:barcode, :product_name))
    ...
    def update
      ...
      @inventory_lot.assign_attributes(inventory_lot_params.except(:barcode, :product_name))
    ...
    def raw_inventory_lot_params
      ...
      params[:inventory_lot].permit(:product_id, :barcode, :product_name, :expires_on, :quantity, :unit, :status, :received_on, :source, :notes)
    end
    ...
    def apply_prefill_to_new_lot(lot)
      ...
      lot.assign_attributes(prefill.except(:product_id, :barcode, :product_name))
